...
show copyright notice\n\
 usage: copyright", 27},
  {"\
DON'T PANIC\n\
 usage: help [command(s)]", 28},
  {"\
get remote help\n\
 usage: rhelp [command]", 29},
  {"\
set program variables\n\
 usage: set [variable] [value]", 30},
  {"\
execute shell command or invoke shell\n\
 usage: shell [shell command]", 31},
  {"show version", 32},
  {"show warranty (or lack of)", 33},
  {"set protection level", 34},
...
~/.yafc/nohup/nohup.<pid>\n\
  ...
  {"Local file '%s' exists, overwrite?", 56},
  {"symlinking '%s' to '%s'\n", 57},
  {"Delete remote file '%s'?", 58},
  {"%s: deleted\n", 59},
  {"error deleting '%s': %s\n", 60},
  {"Get '%s'?", 61},
...
Options:\n\
  ...
  -h, --help              show this help\n", 103},
  {"Unable to save local taglist file", 104},
  {"Saved local taglist to %s\n", 105},
  {"No saved local taglist\n", 106},
  {"Found saved local taglist, load it now?", 107},
...
\n", 110},
  {"creating working directory %s: ", 111},
  {"done\n", 112},
  {"creating directory %s: ", 113},
  {"creating default config file /yafcrc: ", 114},
  {"\
...
yafc\n\
  ...
  {"File '%s' exists, overwrite?", 124},
  {"Delete local file '%s'?", 125},
  {"Put '%s'?", 126},
...
Options:\n\
  ...
  -v, --verbose         explain what is being done\n\
      --help            display this help\n", 150},
  {"Remove remote file '%s'?", 151},
  {"%s  omitting directory\n", 152},
  {"no files found\n", 153},
  {"autologin is on", 154},
  {"autologin is off", 155},
  {"verbose is on", 156},
  {"verbose is off", 157},
  {"passive mode is on", 158},
  {"passive mode is off", 159},
  {"debug is on", 160},
  {"debug is off", 161},
...
trying 'ftp' instead...\n", 191},
  ...
  {"setsockopt(THROUGHPUT)... ignored", 234},
  {"setsockopt(LOWDELAY)... ignored", 235},
